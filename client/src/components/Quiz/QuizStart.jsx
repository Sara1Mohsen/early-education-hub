...
export function QuizStart({ onStart }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 text-white p-6">
      <div className="max-w-2xl mx-auto text-center space-y-8">
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-300">
            التصميم ثلاثي الأبعاد والواقع الافتراضي
          </p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 space-y-6">
          <div className="flex items-start gap-4 text-right">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">عن الاختبار:</h3>
